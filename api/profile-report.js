...
function buildPrompt(format, input) {
  ...
  return [
    ...
    "- 동시에, 각 문구는 '한 줄을 거의 꽉 채울 만큼' 충분히 길고 밀도 있게 작성한다. 공백 포함 대략 '한글 32~38자(영문 위주면 60~72자)'를 목표로 한다. 너무 짧은 문장/키워드 나열은 품질 저하로 금지.",
    "- 이 밀도 규칙은 headline(-), bullet(·), talking point, ※ 참고사항 등 모든 문장에 동일 적용한다. 근거·수식어·구체 성과를 덧붙여 한 줄을 채운다.",
