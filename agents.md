...
- GitHub Actions workflow `.github/workflows/trending-mail-cron.yml` calls `/api/trending-mail-cron` every 5 minutes so UI-configured send time can be honored without Vercel Pro Cron.
